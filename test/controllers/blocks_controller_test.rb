...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { active: @block.active, attention_level: @block.attention_level, code: @block.code, name: @block.name, short_name: @block.short_name }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { active: @block.active, attention_level: @block.attention_level, code: @block.code, name: @block.name, short_name: @block.short_name }
    assert_redirected_to block_path(assigns(:block))
  end
